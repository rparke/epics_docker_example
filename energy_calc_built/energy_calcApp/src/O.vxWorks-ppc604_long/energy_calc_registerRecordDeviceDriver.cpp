...
/* Generated from ../O.Common/energy_calc.dbd */
...
epicsShareExtern int *pvar_int_CASDEBUG;
...
static struct iocshVarDef vardefs[] = {
	...
	{"CASDEBUG", iocshArgInt, (void * const)pvar_int_CASDEBUG},
...
int energy_calc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/eja26438/Documents/EPICS_CONTAINERS/epics_docker_example/energy_calc_built";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"energy_calc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    energy_calc_registerRecordDeviceDriver(*iocshPpdbbase);
}
